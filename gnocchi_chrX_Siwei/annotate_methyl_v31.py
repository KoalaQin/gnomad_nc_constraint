...
# context_ht = hl.read_table('gs://gnomad-nc-constraint-v31/context_methyl_CpG.ht')
...
context_ht.write('gs://gnomad-nc-constraint-v31/methylation/context_prepared_methyl_CpG.ht', overwrite=True)
